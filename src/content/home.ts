        ...
        'stage-1': {
            ...
            data: [
                ...
                },
                {
                    ...
                    content: [
                        'Eating to support recovery. Sleep hygiene during stress. Safe movement & light fitness'
                    ],
                },
                {
                    heading: 'Managing the Mental Load',
                    content: [
                        'How to cope with “what if” thoughts. Support networks and simple tools. When and how to ask for help.'
                    ],
                }
            ],
        },
            ...
            data: [
                {
                    ...
                    content: [
                        'Treatment paths: surgery, radiation, hormone therapy. What to expect during and after. Working with your medical team.'],
                },
                {
                    heading: 'Staying Emotionally Steady',
                    content: [
                        'Mental health check-ins. Talking to family, friends, or a counselor. Guided tools to reduce overwhelm.'],
                },
                {
                    heading: 'Your Body, Your Needs',
                    content: [
                        'Managing side effects through food & rest. Handling fatigue & disrupted sleep. Keeping active within your limits.'],
                },
            ],
        },
        'stage-3': {
            ...
            data: [
                {
                    ...
                    content: [
                        'Stage 3 treatment landscape. Coordinating care across teams. Understanding more complex symptoms.'],
                },
                {
                    heading: 'Caring for a Tired Body',
                    content: [
                        'Gentle nutrition and hydration tips.Fatigue, sleep disruption, and what helps. Movement when you can — or resting when you need.'],
                },
                {
                    heading: 'Finding Your Ground',
                    content: [
                        'Naming difficult emotions. Support groups that feel real. Keeping some control in the chaos'],
                }
            ],
        },
        'stage-4': {
            ...
            data: [
                {
                    ...
                    content: [
                        'Treatment vs. comfort decisions. What palliative support actually means. Being heard by your team'],
                },
                {
                    heading: 'Support for the Day-to-Day',
                    content: [
                        'Eating what feels right. Sleep, pain relief, and symptom tools. Movement, touch, or stillness — what works for you.'],
                },
                {
                    heading: 'Honouring Your Life',
                    content: [
                        'Processing what matters to you. Creative legacy & joy in small things. Support for family & chosen whānau'],
                }
            ],
        },
        'caregiver': {
            ...
            data: [
                {
                    ...
                    content: [
                        'What’s happening in your loved one’s body. How to assist with treatment & symptoms. Clear answers to tough questions.'],
                },
                {
                    heading: 'You’re Part of This — But You’re Still You',
                    content: [
                        'Managing burnout, sleep loss, and food fatigue. Fitness or rest — what your body asks for. Emotional weight & how to put it down sometimes.'],
                },
                {
                    heading: 'Real Support for Real People',
                    content: [
                        'Who to call, where to go. Practical guides, appointment planners. Honest voices from other caregivers.'],
                }
            ],
        },
        'researcher': {
                ...
                data: [
                {
                    ...
                    content: [
                        'Disease progression: staging, grading, biomarkers. Diagnostic pathways: PSA, biopsy, imaging. Cross-system comparisons (NZ, AUS, US, EU). Population data & cohort breakdowns'],
                },
                {
                    heading: 'Trials, Treatment & Innovation',
                    content: [
                        'Ongoing trials & novel therapies (NZ/international). Treatment outcomes by demographic & stage. Health equity & access gaps. NZ-specific research themes (rural, Māori, Pacific populations).'],
                },
                {
                    heading: 'Tools, Grants & Collaboration',
                    content: [
                        'Active and upcoming grant opportunities (HRC, MBIE, etc.). Submission guidelines & funding timelines. Participant recruitment tools. Data-sharing agreements & ethics resources. Researcher contact networks & collaboration portals'],
                }
            ]
        }
    }
