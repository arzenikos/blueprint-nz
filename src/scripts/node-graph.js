export function initBluenodeGraph(bluenodeData) {
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const nodeColors = {
      root: ' var(--color-palette-five)',
      parent: ' var(--color-palette-five)',
      child: ' var(--color-palette-five)'
    };
    ...
    function createNodeElement(nodeData, nodeType = 'child') {
      ...
      nodeElement.innerHTML = `
        <div class="rounded-lg flex items-center justify-center shadow-md hover:scale-105 transition-transform duration-300 px-4 py-2 min-w-[120px] node-box">
    ...
    function showNodeDetail(nodeData) {
      ...
      if (detailTitle && detailSubtitle && detailContent) {
        ...
        // Create content
        let content = `
          <div class="p-4 rounded-lg mb-6" style="color: var(--color-palette-five); ">
  ...
  // Your script logic goes here (pan/zoom/init/connection drawing etc.)
  // Optionally wrap it in an IIFE or class if needed
}
